...
There is two API endpoints available you can use to upload your audio files to ThinLine Radio.

## Endpoint: /api/call-upload

This API is used by the **downstream** feature to receive audio files from other ThinLine Radio or Rdio Scanner instances (cross-compatible).
...
```bash
$ curl https://other-thinline-radio.example.com/api/call-upload \
